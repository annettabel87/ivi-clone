      ...
      <div className={styles.personFilmographyItem}>
        ...
        <div className={styles.personFilmographyItemMain}>
          <div className={styles.personFilmographyItemInfos}>
            ...
            {film.hasOwnProperty('rate') && <h3 className={styles.personFilmographyItemRating}>Рейтинг Иви: {film.rate.kinopoisk}</h3>}
          </div>
          <div>
            <button onClick={() => router.push(`/film/${film.filmId}`)} className={styles.personFilmographyItemButton}>Подробнее</button>
          </div>
        </div>
      </div>
    </>
