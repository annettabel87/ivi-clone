import { MAIN_ROUTE, FILMS_ROUTE, SERIALS_ROUTE, CARTOONS_ROUTE } from '../constants/routes';
...
export const navbarLinks: INavbarLink[] = [
  ...
  { title: 'Сериалы', titleEng: 'Serials', link: SERIALS_ROUTE, section: 'serials' },
  { title: 'Мультфильмы', titleEng: 'Cartoons', link: CARTOONS_ROUTE, section: 'cartoons' },
